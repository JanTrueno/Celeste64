...
internal static class Platform
{
	...
	[DllImport(DLL)]
	public static extern void FosterMeshSetInstanceFormat(IntPtr mesh, ref FosterVertexFormat format);
	[DllImport(DLL)]
	public static extern void FosterMeshSetInstanceData(IntPtr mesh, IntPtr data, int dataSize, int dataDestOffset);
	[DllImport(DLL)]
