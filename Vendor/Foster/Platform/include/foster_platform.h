...
FOSTER_API void FosterMeshSetInstanceFormat(FosterMesh* mesh, FosterVertexFormat* format);

FOSTER_API void FosterMeshSetInstanceData(FosterMesh* mesh, void* data, int dataSize, int dataDestOffset);
