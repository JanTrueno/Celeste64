...
typedef struct FosterRenderDevice
{
	...
	void (*meshSetInstanceFormat)(FosterMesh* mesh, FosterVertexFormat* format);
	void (*meshSetInstanceData)(FosterMesh* mesh, void* data, int dataSize, int dataDestOffset);
